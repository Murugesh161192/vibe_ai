  ...
  return (
    <div className="spacing-responsive">
      ...
      <div className="card-glass p-6 sm:p-8 hover-lift relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="spacing-responsive relative z-10" aria-label="Repository URL form">
          <div className="text-center mb-6">
            <h3 className="text-heading-md text-white mb-2 icon-text-align justify-center">
              <Github className="icon-lg text-indigo-400" />
          ...
          <div>
            <label htmlFor="repoUrl" className="block text-sm font-semibold text-white/90 mb-3 icon-text-align-sm">
              <span className="w-2 h-2 bg-gradient-to-r from-indigo-400 to-purple-600 rounded-full"></span>
              <span>GitHub Repository URL</span>
            </label>
            <div className="input-icon-left group">
              <div className="icon">
                <Github className="icon-lg text-white/50 group-focus-within:text-indigo-400 transition-all duration-200" />
              </div>
              <input
                id="repoUrl"
                type="url"
                ...
                className={`input-glass w-full py-4 sm:py-5 text-responsive font-medium touch-target ${
            ...
            {(error || (!isValid && errorMessage)) && (
              <div 
                id="url-error" 
                className="mt-3 icon-text-align gap-2 text-red-300 text-responsive bg-red-900/20 border border-red-500/30 rounded-lg p-3"
                role="alert"
                aria-live="polite"
              >
          ...
          <div className="flex justify-center pt-2">
            <button
              ...
              className={`btn-primary icon-text-align px-8 sm:px-10 py-4 sm:py-5 text-responsive font-semibold rounded-xl shadow-2xl relative overflow-hidden group touch-target ${
            ...
            >
              ...
              <div className="relative z-10 icon-text-align">
                <Zap className="icon-lg group-hover:rotate-12 transition-transform" />
      ...
      <div className="card-content p-6 sm:p-8 hover-lift relative overflow-hidden">
        ...
        <div className="text-center mb-6 sm:mb-8 relative z-10">
          <div className="icon-text-align justify-center mb-3 sm:mb-4">
            ...
            <h4 className="text-heading-md text-white">What is a Vibe Score?</h4>
          </div>
          <p className="text-white/80 leading-relaxed text-responsive max-w-2xl mx-auto mb-4 sm:mb-6">
          ...
          <button
            ...
            className={`btn-secondary icon-text-align mx-auto text-responsive px-4 sm:px-6 py-3 hover-lift transition-all duration-200 touch-target ${
          ...
          >
            ...
            {showMetrics ? <ChevronUp className="icon-md" /> : <ChevronDown className="icon-md" />}
          </button>
        </div>
            ...
            <div className="mb-6 sm:mb-8">
              <div className="flex items-center justify-between gap-3 mb-4">
                <div className="flex items-center gap-2 min-w-0 flex-1">
                  ...
                  <h5 className="text-responsive font-bold text-white uppercase tracking-wide truncate">
                    High Priority Metrics
                  </h5>
                </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2 mb-1">
                          <h6 className="text-white text-responsive font-semibold truncate">{metric.name}</h6>
